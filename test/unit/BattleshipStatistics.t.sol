...
contract BattleshipStatisticsTest is Test {
    ...
    function testLeaderboard() public {
        ...
        BattleshipStatistics.LeaderboardEntry[] memory winsBoard = stats.getLeaderboard(stats.WINS_LEADERBOARD(), 10);
        ...
        assertEq(rateBoard[0].score, 10_000); // 100%
    ...
    function testManuallyUpdateLeaderboard() public {
        ...
        BattleshipStatistics.LeaderboardEntry[] memory board = stats.getLeaderboard(stats.WINS_LEADERBOARD(), 10);
    ...
    function test_RevertWhen_UpdateLeaderboardNotAdmin() public {
        // For simplicity since the exact error format can vary based on Solidity version and AccessControl
        // implementation,
